...
- [ ] 1. Phase 1 — Extended VM Types and State
  - [ ] 1.1 Extend Forth_VM package specification with new types and VM_State fields
  ...
  - [ ] 1.2 Extend VM_Is_Valid and Dict_Entries_Valid
  ...
  - [ ] 1.3 Update Initialize procedure to register new built-in primitives
  ...
  - [ ] 1.4 Add procedure declarations for new operations in forth_vm.ads
...
- [ ] 2. Phase 1 — Core Implementation (Emit, Finalize, Execute_Word)
  - [ ] 2.1 Implement Emit_Instruction in forth_vm.adb
  ...
  - [ ] 2.2 Implement Finalize_Definition in forth_vm.adb
  ...
  - [ ] 2.3 Implement Execute_Word (iterative inner interpreter) in forth_vm.adb
  ...
  - [ ] 2.4 Implement or extend Dispatch_Primitive helper in forth_vm.adb
...
- [ ] 3. Phase 1 — Extended Outer Interpreter (Compilation Mode)
  - [ ] 3.1 Extend Interpret_Result with Compile_Error value in forth_interpreter.ads
    - Add Compile_Error to the Interpret_Result enumeration
    - _Requirements: 16.5_

  - [ ] 3.2 Extend Lookup to return entry index instead of just Op
    - Modify Lookup to output Found (Boolean), Entry_Idx (Natural) instead of just the Op
    - Update all existing callers of Lookup
    - _Requirements: 16.1, 16.2_

  - [ ] 3.3 Implement compilation mode in Interpret_Line
  ...
  - [ ] 3.4 Implement Compile_Token helper procedure
  ...
  - [ ] 3.5 Extend interpretation mode dispatch for User_Defined_Entry and Variable_Entry
...
- [ ] 4. Phase 1 — GNATprove Verification and Integration Tests
  - [ ] 4.1 Run GNATprove and resolve all verification conditions for Phase 1
